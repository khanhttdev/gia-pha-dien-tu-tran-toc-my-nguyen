    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <div className="relative pt-16 pb-12 border-b border-border/40 bg-card overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <div className="mb-6 flex">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-amber-400 transition-colors uppercase tracking-widest font-semibold"
            >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl leading-relaxed font-serif">
            Tìm hiểu cách khai thác hiệu quả các tính năng trên website Gia phả
            Điện tử Trần Tộc Mỹ Nguyên để theo dõi cội nguồn và kết nối với
            người thân.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-4">
            <div className="sticky top-24 space-y-2">
              <h3 className="text-white/80 font-semibold mb-4 uppercase tracking-widest text-sm border-b border-white/10 pb-2">
                Nội dung hướng dẫn
              </h3>
              {guideSections.map((section) => {
                ...
                return (
                  ...
                  >
                    <section.icon
                      className={`w-4 h-4 ${isActive ? "text-amber-400" : "opacity-60"}`}
                    />
                          ...
                          return (
                            <li
                              ...
                              dangerouslySetInnerHTML={{
                                __html: html.replace("-", "").trim(),
                              }}
                              className="ml-4 list-disc marker:text-amber-500"
                            />
                          );
                        }
                        return (
      ...
      <div className="pb-20 text-center px-6">
        <p className="text-muted-foreground mb-6">
          Bạn đã nắm rõ cách sử dụng hệ thống?
        </p>
        <Link
          href="/register"

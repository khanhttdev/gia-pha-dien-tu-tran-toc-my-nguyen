    ...
    return (
        <div className={cn(
            ...
            <div className={cn(
                ...
                {meta.avatar_url
                    ? <img src={meta.avatar_url} alt={member.full_name} width={64} height={64} className="w-full h-full object-cover grayscale-[15%] group-hover/profile:grayscale-0 transition-all" />
                    : isMale ? '👨' : isFemale ? '👩' : '👤'
                }
            </div>
...
function PersonNodeComponent({ data, selected }: NodeProps<PersonNodeType>) {
    ...
    return (
        <div className={cn(
            ...
            isRoot ? 'border-amber-400 ring-1 ring-amber-500/50 shadow-[0_0_40px_rgba(251,191,36,0.2)]' : 'border-amber-600/30',
            selected
                ...
                : isHighlighted
                    ...
                    : isRoot ? 'hover:scale-[1.02]' : 'hover:border-amber-500/50 hover:shadow-[0_10px_40px_rgba(245,158,11,0.3)]',

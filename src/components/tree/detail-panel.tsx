          ...
          <div className="relative h-full flex flex-col overflow-y-auto custom-scrollbar p-6">
              ...
              <div
                className={cn(
                  ...
                  isMale
                    ...
                    : "border-pink-400/50 shadow-pink-500/10",
                )}
              >
                <div className="w-full h-full rounded-2xl overflow-hidden bg-[#1B0506]">
                  <img
                    src={
                      isMale
                        ? "https://img.icons8.com/color/144/circled-user-male-type-7.png"
                        : "https://img.icons8.com/color/144/circled-user-female-type-7.png"
                    }
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex flex-col gap-2">
                ...
                <span className="text-[10px] text-amber-200/40 font-bold uppercase tracking-wider">
                  Ngày sinh
                </span>
                <span className="text-sm text-amber-50 font-medium">
                  {String(meta.birth_day || "---")}
                </span>
              </div>
              <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex flex-col gap-2">
                ...
                <span className="text-sm text-amber-50 font-medium">
                  {member.birth_order ? `Số ${member.birth_order}` : "---"}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {spouses.map((s) => (
                      ...
                      >
                        <div className="w-6 h-6 rounded-full bg-pink-400/20 border border-pink-400/40 flex items-center justify-center text-[10px]">
                          👩
                        </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-amber-50/70 leading-relaxed bg-white/5 p-3 rounded-xl border border-white/5">
                  {String(
                    meta.occupation || "Dữ liệu đang được dòng họ cập nhật...",
                  )}
                </p>
              </div>
            </div>

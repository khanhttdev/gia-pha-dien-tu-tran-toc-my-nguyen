...
const variantConfig = {
  ...
  destructive: {
    icon: Trash2,
    iconClass:
      "text-red-400 bg-gradient-to-br from-red-500/20 to-red-600/10 ring-2 ring-red-500/20",
    confirmClass:
        ...
        <DialogHeader className="items-center text-center gap-3">
          ...
          >
            <Icon
              className={cn(
                "w-7 h-7",
                isDestructive && "animate-in spin-in-12 duration-500",
              )}
            />
          </div>
          <DialogTitle
            className={cn("text-lg", isDestructive && "text-red-500")}
          >
            {title}
          </DialogTitle>
          {description && (

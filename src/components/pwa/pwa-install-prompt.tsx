...
export function PwaInstallPrompt() {
  ...
  return (
    <div
      className={`fixed bottom-4 right-4 z-50 w-[calc(100%-2rem)] sm:w-[360px] rounded-2xl border border-amber-500/20 bg-background/90 backdrop-blur-xl shadow-2xl shadow-black/20 p-4 transition-all duration-300 ${
        isExiting

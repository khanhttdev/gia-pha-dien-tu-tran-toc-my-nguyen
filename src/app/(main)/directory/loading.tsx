...
export default function DirectoryLoading() {
  return (
    <div
      aria-label="loading"
      className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6 sm:space-y-8 animate-in fade-in duration-500"
    >
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div
            key={i}
            className="glass rounded-2xl p-5 sm:p-6 border border-border/50 relative overflow-hidden group hover:border-amber-500/30 transition-all duration-300"
          >
            {/* Header card */}

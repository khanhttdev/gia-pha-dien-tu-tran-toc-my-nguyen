...
export default function EventsPage() {
  ...
  const EventCard = ({ e }: { e: Event }) => {
    ...
    return (
      <div
        className={cn(
          "glass rounded-xl p-4 border transition-all group",
          isPast
          ...
          <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Badge
                  variant="outline"
                  className={cn("text-[10px] px-1.5 py-0 border", meta.color)}
                >
                  {meta.label}
                </Badge>
              </div>
    ...
    <div className="h-full flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                {upcoming.length} sự kiện sắp tới
              </p>
            </div>
          </div>
          {isAdmin && (
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editTarget ? "Chỉnh sửa sự kiện" : "Thêm sự kiện mới"}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-3 py-2">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                placeholder="Nhà thờ họ, địa chỉ..."
              />
            </div>
            <div className="space-y-1">
              <Label>Mô tả</Label>
